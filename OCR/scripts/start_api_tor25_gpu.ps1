...
$Command = "`$env:PYTHONPATH='$PythonPath'; `$env:OCR_CONFIG='$ConfigPath'; & 'D:\Anaconda3\envs\tor25\python.exe' -m ocr_service.cli"
...
Write-Host "OCR API tor25 GPU started: $($Process.Id)"
